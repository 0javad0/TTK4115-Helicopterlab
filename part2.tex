...
For a critically damped system $\zeta = 1$, which gives the following relationship
...
$K_{rp}$. The value that was deemed best was $K_{rp}$ = \todo{fill in
  this value}. Higher values of $K_{rp}$ led to \todo{Describe
  performance}, while lower values of $K_{rp}$ led to \todo{describe
  performance}.  It was not nessecary to add a gain to the x value of
