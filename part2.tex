...
helicopter than with just feed forward joystick control as no scaling of the joystick input was needed.
...
$K_{rp}$. The value that was deemed best was $K_{rp}$ = -2. Higher values, or more negative values, of $K_{rp}$ led to large oscillations, while lower values, or less negative values, of $K_{rp}$ led to a slower response to the joysticks input.  It was not necessary to add a gain to the x value of
